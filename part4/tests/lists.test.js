...
describe('Most Liked', () => {
  ...
  test('when list with 3 blogs is passed, blog with maximum likes is returned', () => {
...
describe('Most Blogs', () => {
  test('When list of blogs is passed, author with max number of blogs is returned', () => {
    const maxAuthor = {
      author: 'Robert C. Martin',
      blogs: 3
    }
...
describe('Most Likes', () => {
  test('returns the author whose posts have most likes', () => {
    const maxAuthor = {
      author: 'Edsger W. Dijkstra',
      likes: 17
    }
